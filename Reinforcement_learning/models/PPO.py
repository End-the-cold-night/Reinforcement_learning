...
class PPO(object):
    ...
    def __init__(self, METHOD, S_DIM=3, A_DIM = 3, A_LR = 0.0001, C_LR = 0.0002, A_UPDATE_STEPS = 10, C_UPDATE_STEPS = 10):
        ...
        with tf.variable_scope('critic'):
            ...
            self.tfdc_r = tf.placeholder(tf.float32, [None, 1], 'discounted_r')  #discounted reward,  Q
        ...
        with tf.variable_scope('loss'):
            ...
            else:   # clipping self.METHOD, find this is better
    ...
    def learn(self, s, a, r):
        ...
        else:   # clipping self.METHOD, find this is better (OpenAI's paper)
